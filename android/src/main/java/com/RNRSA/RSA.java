...
public class RSA {
    ...
    private final Cipher getCipher() throws NoSuchAlgorithmException, NoSuchProviderException {
        if(this.keyTag != null){
    ...
    private final Signature getSignature() throws NoSuchAlgorithmException, NoSuchProviderException {
        if(this.keyTag != null){
